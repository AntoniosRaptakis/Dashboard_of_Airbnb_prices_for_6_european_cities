...
geo_amsterdam = geopandas.read_file('Amsterdam_new_neighbourhoods.geojson', driver='GeoJSON')
geo_lisbon = geopandas.read_file('Lisbon_new_neighbourhoods.geojson', driver='GeoJSON')
geo_london = geopandas.read_file('London_new_neighbourhoods.geojson', driver='GeoJSON')
geo_paris = geopandas.read_file('Paris_new_neighbourhoods.geojson', driver='GeoJSON')
geo_rome = geopandas.read_file('Rome_new_neighbourhoods.geojson', driver='GeoJSON')
geo_vienna = geopandas.read_file('Vienna_new_neighbourhoods.geojson', driver='GeoJSON')
